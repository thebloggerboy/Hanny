...
FILE_DATA = {
    "Episode1": {
        "id": "BAACAgUAAxkBAAMXaGpSqvDgq-0fAszJ6iItqfYpI7wAAroTAALdcVBXt_ZT-2d9Lno2BA",  # <-- यहाँ Episode 1 की असली ID डालें
...
# --- UptimeRobot के लिए Keep-Alive सर्वर (Corrected) ---
app = Flask('')
@app.route('/')
def home():
...
def run():
    # यह Replit के लिए सही पोर्ट का उपयोग करेगा
...
# --- File ID बताने वाला नया और बेहतर फंक्शन (Corrected) ---
async def get_id(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ... आप और भी फाइल टाइप यहाँ जोड़ सकते हैं
